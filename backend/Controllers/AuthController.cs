...
[Route("Auth")]
[AllowAnonymous]
public class AuthController(IConfiguration c, AuthService authService) : ControllerBase
{
    private readonly IConfiguration _configuration = c;
    ...
    public async Task<IActionResult> Login([FromBody] LoginRequest request)
    {
        ...
        if (user == null) Console.WriteLine("user je null");
